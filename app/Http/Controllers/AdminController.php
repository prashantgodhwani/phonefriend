...
class AdminController extends Controller
{
    ...
    public function getPhonesBetweenDates(Request $request){
        ...
        $orders =DB::table('order_devices')->select('data.id', DB::raw("count('order_devices.order_id') as sales"))->join('orders','orders.id','=','order_devices.order_id')->join('phones','phones.id','=','order_devices.phone_id')->join('data','data.id','=','phones.data_id')->whereBetween(DB::raw('date(orders.created_at)'), [Carbon::createFromFormat('Y-m-d', $start)->toDateString(), Carbon::createFromFormat('Y-m-d', $end)->toDateString()])->where('data.id',$request->phoneId)->groupBy('data.id')->orderBy('sales', 'DESC')->get();
        $codAttempted = DB::table('order_devices')->select('data.id', DB::raw("count('order_devices.order_id') as sales"))->join('orders','orders.id','=','order_devices.order_id')->join('phones','phones.id','=','order_devices.phone_id')->join('data','data.id','=','phones.data_id')->whereBetween(DB::raw('date(orders.created_at)'), [Carbon::createFromFormat('Y-m-d', $start)->toDateString(), Carbon::createFromFormat('Y-m-d', $end)->toDateString()])->where('orders.payment_mode','cod')->where('data.id',$request->phoneId)->groupBy('data.id')->orderBy('sales', 'DESC')->get();
        $codSuccess = DB::table('order_devices')->select('data.id', DB::raw("count('order_devices.order_id') as sales"))->join('orders','orders.id','=','order_devices.order_id')->join('phones','phones.id','=','order_devices.phone_id')->join('data','data.id','=','phones.data_id')->whereBetween(DB::raw('date(orders.created_at)'), [Carbon::createFromFormat('Y-m-d', $start)->toDateString(), Carbon::createFromFormat('Y-m-d', $end)->toDateString()])->where('orders.payment_mode','cod')->where('data.id',$request->phoneId)->where('order_status', 'Success')->groupBy('data.id')->orderBy('sales', 'DESC')->get();
        $codCancelled = DB::table('order_devices')->select('data.id', DB::raw("count('order_devices.order_id') as sales"))->join('orders','orders.id','=','order_devices.order_id')->join('phones','phones.id','=','order_devices.phone_id')->join('data','data.id','=','phones.data_id')->whereBetween(DB::raw('date(orders.created_at)'), [Carbon::createFromFormat('Y-m-d', $start)->toDateString(), Carbon::createFromFormat('Y-m-d', $end)->toDateString()])->where('orders.payment_mode','cod')->where('data.id',$request->phoneId)->where('order_status', 'Cancelled')->groupBy('data.id')->orderBy('sales', 'DESC')->get();

        $ccdcAttempted= DB::table('order_devices')->select('data.id', DB::raw("count('order_devices.order_id') as sales"))->join('orders','orders.id','=','order_devices.order_id')->join('phones','phones.id','=','order_devices.phone_id')->join('data','data.id','=','phones.data_id')->whereBetween(DB::raw('date(orders.created_at)'), [Carbon::createFromFormat('Y-m-d', $start)->toDateString(), Carbon::createFromFormat('Y-m-d', $end)->toDateString()])->where('orders.payment_mode','ccdc')->where('data.id',$request->phoneId)->groupBy('data.id')->orderBy('sales', 'DESC')->get();
        $ccdcSuccess = DB::table('order_devices')->select('data.id', DB::raw("count('order_devices.order_id') as sales"))->join('orders','orders.id','=','order_devices.order_id')->join('phones','phones.id','=','order_devices.phone_id')->join('data','data.id','=','phones.data_id')->whereBetween(DB::raw('date(orders.created_at)'), [Carbon::createFromFormat('Y-m-d', $start)->toDateString(), Carbon::createFromFormat('Y-m-d', $end)->toDateString()])->where('orders.payment_mode','ccdc')->where('data.id',$request->phoneId)->where('order_status', 'Success')->groupBy('data.id')->orderBy('sales', 'DESC')->get();
        $ccdcUP = DB::table('order_devices')->select('data.id', DB::raw("count('order_devices.order_id') as sales"))->join('orders','orders.id','=','order_devices.order_id')->join('phones','phones.id','=','order_devices.phone_id')->join('data','data.id','=','phones.data_id')->whereBetween(DB::raw('date(orders.created_at)'), [Carbon::createFromFormat('Y-m-d', $start)->toDateString(), Carbon::createFromFormat('Y-m-d', $end)->toDateString()])->where('orders.payment_mode','ccdc')->where('data.id',$request->phoneId)->where('order_status', 'UP')->groupBy('data.id')->orderBy('sales', 'DESC')->get();
        $ccdcAborted = DB::table('order_devices')->select('data.id', DB::raw("count('order_devices.order_id') as sales"))->join('orders','orders.id','=','order_devices.order_id')->join('phones','phones.id','=','order_devices.phone_id')->join('data','data.id','=','phones.data_id')->whereBetween(DB::raw('date(orders.created_at)'), [Carbon::createFromFormat('Y-m-d', $start)->toDateString(), Carbon::createFromFormat('Y-m-d', $end)->toDateString()])->where('orders.payment_mode','ccdc')->where('data.id',$request->phoneId)->where('order_status', 'Aborted')->groupBy('data.id')->orderBy('sales', 'DESC')->get();
        //dd($codAttempted, $codSuccess, $ccdcAttempted, $ccdcSuccess, $ccdcUP, $ccdcAborted);
        return view('admin.phoneshistory', compact('orders','codAttempted', 'codSuccess', 'codCancelled', 'ccdcAborted','ccdcSuccess', 'ccdcAttempted', 'ccdcUP'));
    }
}
