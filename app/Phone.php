...
class Phone extends Model
{
    ...
    protected $fillable=['data_id','storage','imei1','imei2','age','price','physical_condition','remarks','dp','sold','visibility','units','units_rem','color','specifications'];
    ...
    public function toSearchableArray()
    {
        ...
        $record['buy_url'] = 'https://www.phonefriend.in/phone/purchase/'.$this->id.'/'.str_slug($this->data->company." ".$this->data->model." ".$this->data->storage." GB", '-').'/'.$phoneColor[0];
