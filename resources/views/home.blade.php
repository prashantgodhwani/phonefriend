...
@section('content')
										...
										<li class="product product-card bestselling-card">
											...
											<div class="product-outer" style="height: 215px;">
												<div class="media product-inner" style="    padding: 0.786em 1.429em;">
													...
													<a class="media-left" href="https://phonefriend.in/store/show/{{$phone->id}}/{{str_slug($phone->data->company." ".$phone->data->model." ".$phone->data->storage." GB", "-")}}#mobileView" title="Pendrive USB 3.0 Flash 64 GB">
														<img class="media-object wp-post-image img-responsive" src="https://www.phonefriend.in/storage/{{str_replace("public", "", $phone->dp)}}" alt="{{ucwords($phone->data->company)}} {{$phone->data->model}} - {{$phone->data->storage}} GB second hand phone at phonefriend" title="{{ucwords($phone->data->company)}} {{$phone->data->model}} - {{$phone->data->storage}} GB" >
													</a>
													...
													<div class="media-body">
														...
														<a href="https://phonefriend.in/store/show/{{$phone->id}}/{{str_slug($phone->data->company." ".$phone->data->model." ".$phone->data->storage." GB", "-")}}#mobileView">
															<h3>{{ucwords($phone->data->company)}} {{$phone->data->model}} - {{$phone->data->storage}} GB</h3>
														</a>
														...
														<div class="price-add-to-cart">
															<div style="margin-bottom: -3px;font-size: 16px;">
																...
																@if($phone->rating > 0)
																	...
																	<div class="rating col-md-5" title="{{($phone->rating / 5) * 100}}%">
															...
															<span class="price">
                                                                            <span class="electro-price">
                                                                                <ins><span class="woocommerce-Price-amount amount"><i class="fa fa-inr"></i> {{number_format($phone->price, 0) }}</span></ins>&nbsp;
                                                        <span class="woocommerce-Price-amount amount cutoff"><i class="fa fa-inr"></i>{{number_format($phone->data->price,0)}}</span><br>

                                                                            </span>
                                                                        </span>

															<a href="https://phonefriend.in/store/show/{{$phone->id}}/{{str_slug($phone->data->company." ".$phone->data->model." ".$phone->data->storage." GB", "-")}}#mobileView" class="button add_to_cart_button">Add to cart</a>
											...
											<div class="product-inner highlight">
												...
												<a href='https://phonefriend.in/store/show/{{$phone->id}}/{{str_slug($phone->data->company." ".$phone->data->model." ".$phone->data->storage." GB", "-")}}#mobileView'>
													...
													<div class="product-thumbnail" style="">
														...
														<img class="img img-responsive lazyload" src="https://www.phonefriend.in/storage/{{str_replace("public", "", $phone->dp)}}" alt="{{ucwords($phone->data->company)}} {{$phone->data->model}} - {{$phone->data->storage}} GB second hand phone at phonefriend" title="{{ucwords($phone->data->company)}} {{$phone->data->model}} - {{$phone->data->storage}} GB" >
												...
												<div class="price-add-to-cart" style="padding-top: 5%; padding-bottom: 5%; margin-bottom: 1%">
													...
													<div style="margin-bottom: -3px;font-size: 16px;">
														...
														@if($phone->rating > 0)
															...
															@if(!Jenssegers\Agent\Facades\Agent::isMobile())<div class="col-md-4" style="    display: inline-block;
								...
								<div class="category-inner">
									<a href="{{route('store.all',[$brand->company])}}">
										@if($brand->company == "apple")
											<div class="media-img"><img src="https://image.flaticon.com/icons/png/512/23/23656.png" sizes="(max-width: 300px) "></div>
										@elseif($brand->company == "samsung")
											<div class="media-img"><img src="{{asset('images/5ed902c9-a40a.jpg')}}" sizes="(max-width: 300px) "></div>
										@elseif($brand->company == "honor")
											<div class="media-img"><img src="{{asset('images/honor.png')}}" sizes="(max-width: 300px) "></div>
										@elseif($brand->company == "lenovo")
											<div class="media-img"><img src="{{asset('images/lenovo.jpg')}}" sizes="(max-width: 300px) "></div>
										@elseif($brand->company == "oneplus")
											<div class="media-img"><img src="{{asset('images/oneplus.jpg')}}" sizes="(max-width: 300px) "></div>
										@elseif($brand->company == "mi")
											<div class="media-img"><img src="{{asset('images/mi.jpg')}}" sizes="(max-width: 300px) "></div>
										@elseif($brand->company == "google")
											<div class="media-img"><img src="{{asset('images/google.jpg')}}" sizes="(max-width: 300px) "></div>
										@elseif($brand->company == "vivo")
											<div class="media-img"><img src="{{asset('images/vivo.png')}}" sizes="(max-width: 300px) "></div>
										@elseif($brand->company == "oppo")
											<div class="media-img"><img src="{{asset('images/oppo.jpg')}}" sizes="(max-width: 300px) "></div>
										@elseif($brand->company == "nokia")
											<div class="media-img"><img src="https://www.multichannel.com/.image/t_share/MTU0MDYzOTI5Nzk2MTQyMTYy/nokia-logojpg.jpg" sizes="(max-width: 300px) "></div>
										@elseif($brand->company == "motorola")
											<div class="media-img"><img src="{{asset('images/motorola.jpg')}}" sizes="(max-width: 300px) "></div>
										@elseif($brand->company == "lg")
											<div class="media-img"><img src="{{asset('images/lg.jpg')}}" sizes="(max-width: 300px) "></div>
										@elseif($brand->company == "panasonic")
											<div class="media-img"><img src="{{asset('images/panasonic.jpg')}}" sizes="(max-width: 300px) "></div>
										@endif
										<div class="category-title">
											<h4 class="title" style="font-weight: bold;">{{ucwords($brand->company)}} SmartPhones</h4>
										</div>
									</a>
								</div>
							</li>
												...
												<div class="product-inner highlight">
													...
													<a href='https://phonefriend.in/store/show/{{$phone->id}}/{{str_slug($phone->data->company." ".$phone->data->model." ".$phone->data->storage." GB", "-")}}#mobileView'>
														...
														<div class="product-thumbnail" style="">
															...
															<img class="img img-responsive lazyload" src="https://plugins.iamrohit.in/img/Facebook-Style-Content-Loader-For-React.png" data-src="https://www.phonefriend.in/storage/{{str_replace("public", "", $phone->dp)}}" alt="{{ucwords($phone->data->company)}} {{$phone->data->model}} - {{$phone->data->storage}} GB second hand phone at phonefriend" title="{{ucwords($phone->data->company)}} {{$phone->data->model}} - {{$phone->data->storage}} GB" >
    ...
    bottom: 4px;"><span class="grey font" style="display: inline;">{{$phone->rating}} / <b>5.0</b></span></div>@endif
																...
																@else
																	<div class="rating col-md-5 product_disc"><b class="font">NEW ARRIVAL</b></div>
																@endif
															</div>
															<span class="price">
											<span class="electro-price">
    ...
    border-color: #5cb85c;">
					...
					<div class="home-v2-banner-block animate-in-view fadeIn animated" data-animation=" animated fadeIn">
						<div class="home-v2-fullbanner-ad fullbanner-ad" style="margin-bottom: 70px;">
							<a href="{{route('store.all')}}">
								<img src="images/banner-lazyload.jpg" data-src="images/banner.jpg" class="img-fluid lazyload" alt="second hand smartphones at phonefriend">
							</a>
						</div>
					</div>
				...
				<div class="modal-content popup-content">
					<div class="modal-body popup-body" id="popup-box-content">
						<div class="row container">
							@if(!Jenssegers\Agent\Facades\Agent::isMobile())
								<div class ="col-md-5" style="max-height: 600px; background-image: url('https://www.phonefriend.in/assets/images/popup.jpg'); height: -webkit-fill-available;"></div>
							@endif
							<div class="col-md-7">
								<div class="container" style="margin-top: 7%;">
									<span class="title">OFFERS</span>
									<span class="txt">AVAIL DISCOUNTS WORTH <i class="fa fa-inr"></i> 200</span>
									<form action="{{URL('/subscribe-to-offers')}}" accept-charset="UTF-8"  name="excitingForm" id="excitingForm" >
										{{csrf_field()}}
										<div class="form-group col-md-12" style="border-top:0px">
											<label>Enter Name:</label>
											<input type="text" name="offer_name" id="offer_name" class="form-control" required="required">

										</div>
										<div class="form-group col-md-12">
											<label>Enter Email:</label>
											<input type="email" name="offer_email" id="offer_email" class="form-control" required="required">

										</div>
										<div class="form-group col-md-12">
											<label>Enter Mobile No:</label>
											<input type="number" name="offer_mobile" id="offer_mobile" class="form-control" required="required">
										</div>
										<div class="form-group col-md-8 col-md-offset-6">
											<button type="button" class="btn btn-success" name="subscribe" style="background-color:#89249d">Submit</button>
											<button type="button" class="btn btn-default popup-close" style="background-color:#252525" data-dismiss="modal">Close</button>
										</div>
									</form>
								</div>
							</div>
