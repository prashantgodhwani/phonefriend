            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card-box">
                        ...
                        <form role="form" id="MerchantForm" data-toggle="validator" action="{{route('merchant.store')}}" method="POST" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <div class="form-group">
                                <label for="exampleInputEmail1">Merchant Company Name</label>
                                <input type="text" name="cname" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Company Name" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="ckeypersonname" class="form-control" id="exampleInputPassword1" placeholder="Name" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="cmobile" class="form-control" id="exampleInputPassword1" placeholder="Mobile" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="cemail" class="form-control" id="exampleInputPassword1" placeholder="Email" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="cpassword" class="form-control" data-minlength="6" id="exampleInputPassword1" placeholder="Password" required>
                                <small id="emailHelp" class="form-text text-muted">Owner's Email</small>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="caddress" class="form-control" id="exampleInputPassword1" required></textarea>
                                <div class="help-block with-errors"></div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="" placeholder="" id="billing_state" name="billing_state" class="form-control" disabled="disabled" required>
                                <div class="help-block with-errors"></div>
                            </div>

                            <div class="form-group">
                                <label for="exampleInputPassword1">PIN CODE</label>
                                <input type="text" value="" placeholder="" id="billing_state" name="pincode" class="form-control" required>
                                <div class="help-block with-errors"></div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="" placeholder="" id="billing_state" name="cin" class="form-control" required>
                                <div class="help-block with-errors"></div>
                            </div>

                            <div class="form-group">
                                <label for="exampleInputPassword1">Aadhar Number</label>
                                <input type="text" value="" placeholder="" id="billing_state" name="caadhar" class="form-control" required>
                                <div class="help-block with-errors"></div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="" placeholder="" id="billing_state" name="gstin" class="form-control" required>
                                <div class="help-block with-errors"></div>
                            </div>

                            <div class="form-group">
                                <label for="exampleInputPassword1">PAN CARD </label>
                                <input type="text" value="" placeholder="" id="billing_state" name="pan" class="form-control" required>
                                <div class="help-block with-errors"></div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="" placeholder="" id="billing_state" name="period" class="form-control" required>
                                <div class="help-block with-errors"></div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="" placeholder="" id="billing_state" name="marketedby" class="form-control" required>
                                <div class="help-block with-errors"></div>
                            </div>

                            <div class="form-group">
                                <label for="exampleInputPassword1">Aadhar Scanned Copy</label>
                                <input type="file"  id="billing_state" name="aadharphoto" class="form-control" required>
                                <div class="help-block with-errors"></div>
                            </div>

                            <div class="form-group">
                                <label for="exampleInputPassword1">MOU Scanned Copy</label>
                                <input type="file"  id="billing_state" name="mouphoto" class="form-control" required>
                                <div class="help-block with-errors"></div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  id="bank" name="bankk" class="form-control" readonly required>
                                <div class="help-block with-errors"></div>
                            </div>
                            ...
                            <button type="submit" class="btn btn-primary">Generate Merchant</button>
                        </form>
                    </div>
                </div>
                <!-- end col -->
...
@section('scripts')
    ...
    <script type="text/javascript">$('#MerchantForm').validator()</script>
