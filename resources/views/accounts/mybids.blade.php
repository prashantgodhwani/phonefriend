                                ...
                                <table class="table">
                                    ...
                                    @foreach($bids as $bid)
                                        <tr>
                                            ...
                                            <td style="padding-top: 7px;">{{ucwords(\App\Phone::find($bid->phone_id)->data->company. " ". \App\Phone::find($bid->phone_id)->data->model)}}</td>
                                            ...
                                            <td style="padding-top: 7px;">@if($bid->status==0)<a href="{{route('bid.reject',$bid->id)}}"><i class="fa fa-times" aria-hidden="true" style="color: darkred; font-size: 1.7em"></i></a>@else <span style="color: darkred;"><b>N.A.</b>@endif</span> </td>
                                        </tr>
                                        @endforeach
                            ...
                            <ul>
                                <li class="cat-item current-cat"><a href="{{route('account')}}">Manage Your Account</a> <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i>
                                    ...
                                    <ul class='children'>
                                        ...
                                        <li class="cat-item current-cat"><a href="{{route('account.mybids')}}">My Bids</a> </li>
