...
</style><div class="topnavnew" id="mytopnavnew">
	...
	<div class="col-md-6" id="searchbardiv"><div class="input-group" id="aa-input-container">
                        ...
                        <div class="input-group-btn">
                            <button class="btn btn-secondary searchbtn" type="submit" >
                                <i class="ec ec-search" style="font-size: 24px;"></i>
                            </button>
                        </div>
                    </div></div>
		   @if (Auth::guest())
			   <div class="top-right links">
				   ...
				   <ul class="navbar-mini-cart navbar-nav animate-dropdown nav flip" >
					   ...
					   <li class="nav-item dropdown">
						   <a href="{{ route('login') }}" class="nav-link" data-toggle="dropdown" aria-expanded="false" style="font-size: 16px; color:#ffffff">
...
</script><form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                                {{ csrf_field() }}
                            </form>