      ...
      <div class="home-v2-slider" >
         ...
         <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
			...
			<div class="item" style="background-size: cover;">
              <a href="https://phonefriend.in/store/show/549/apple-iphone-5s-16-gb"> <img src="assets/images/slider/banner-9.jpg" class="sliderheight"></a>
               
            </div>
			
			<div class="item" style="background-size: cover;">
                <a href="https://phonefriend.in/store/show/549/apple-iphone-5s-16-gb"><img src="assets/images/slider/banner-10.jpg" class="sliderheight"></a>
               
            </div>
			
			<div class="item" style="background-size: cover;">
               <a href="https://phonefriend.in/store/show/549/apple-iphone-5s-16-gb"> <img src="assets/images/slider/banner-11.jpg" class="sliderheight"></a>
               
            </div>
			
			<div class="item" style="background-size: cover;">
              <a href="https://phonefriend.in/store/show/563/lenovo-k3-note-16-gb"> <img src="assets/images/slider/banner-12.jpg" class="sliderheight"></a>
               
            </div><div class="item" style="background-size: cover;">
...
<h3 class="topsellheading">Top Selling Products</h3>
<img class="img img-responsive topsellingimage" style="margin:5px auto !important" src="https://www.phonefriend.in/images/topselling.png">
</div>
...
.bx-wrapper {
  ...
  <div class="slider">
    ...
    <div width="20%" style="border: 0px solid #ccc;
    margin: 5px;
    padding: 5px;"><div class="">
								<div class="product-inner highlight">
									...
									<a href='https://phonefriend.in/store/show/{{$phone->id}}/{{str_slug($phone->data->company." ".$phone->data->model." ".$phone->data->storage." GB", "-")}}#mobileView'>
										...
										<h3 class="bestselheading">{{ucwords($phone->data->company)}} {{$phone->data->model}} - {{$phone->data->storage}} GB</h3>
										<div class="product-thumbnail" style="">
                                            ...
                                            <div style=" margin-left: 20px;margin-bottom: -3px;font-size: 10px;">
                                                @for($i=1; $i<=5; $i++)
                                            @if($i <= $phone->rating)
                                          ...
                                          @endfor
											...
											<span class="tsale pad" style="display: none" data-toggle="tooltip" title="Price Marked Down"><b>{{round((($phone->data->price - $phone->price) / $phone->data->price )*100)}} %</b><br><span style="    font-size: 10px;">OFF</span></span><br>
										</div>
									</a>
									...
									<div class="price-add-to-cart" style="padding-top: 0%; padding-bottom: 5%; margin-bottom: 1%">
										<span class="price">
									...
									<?php if($phone->units){?><a href="{{URL('/phone/purchase/'.$phone->id.'/'.str_slug($phone->data->company.' '.$phone->data->model.' '.$phone->data->storage.' GB', '-').'/'.$phoneColor[0])}}" ><b class="buynowtop"><i class="fa fa-shopping-cart" aria-hidden="true"></i>
									&nbsp;Buy Now</b></a><?php } 
