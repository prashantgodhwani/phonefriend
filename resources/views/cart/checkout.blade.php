...
To extend warranty on your product please write us at support@phonefeiend.in or call 8574763333.-->
                ...
                <tr class="shipping">
                    <th>Shipping</th>
                    <td data-title="Shipping"><span class="amount"> Free</span> <input type="hidden" class="shipping_method" value="international_delivery" id="shipping_method_0" data-index="0" name="shipping_method[0]"></td>
                </tr>
		...
		<li class="wc_payment_method payment_method_cod">
            ...
            <label for="payment_method_cod">Pay &nbsp;<span style="color:green; font-weight: bold;"><i class="fa fa-inr"></i>{{number_format(number_unformat($val),2) }}</span>&nbsp; at Cash on Delivery</label>
        </li>
        <li class="wc_payment_method payment_method_paypal">
            ...
            <label for="payment_method_paypal">Pay &nbsp;<span style="color:green; font-weight: bold;"><i class="fa fa-inr"></i>{{number_format(number_unformat($val) - ((number_unformat($val) * 1.5) / 100),2) }}</span>&nbsp; by Credit / Debit Card  / Net Banking / EMI</span>
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if(res.data.discount !== 0.0) {
                        ...
                        span.innerHTML = "<del style='color:grey'><i class='fa fa-inr'></i>&nbsp;{{Cart::subtotal()}}</del> &nbsp; <span style='color:green;text-weight:bold;'> <i class=\"fa fa-inr\"></i>&nbsp;" + Math.round(subttl * 100) / 100 + "&nbsp;<span class=\"label label-success\">You save  <i class=\"fa fa-inr\"></i> &nbsp;"+ Math.round(res.data.discount * 100) / 100 +"</span>\n";
                    }else{
                        document.getElementById("couponsavebutton").style.display="none";
                        span = document.getElementById("amount");
                        span.innerHTML = "<span id=\"amount\" class=\"amount\"><i class=\"fa fa-inr\"></i> &nbsp;{!! Cart::subtotal() !!}";
                    }
                },
                error: function () {
